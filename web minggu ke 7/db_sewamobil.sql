...
--
-- Host: localhost    Database: db_sewamobil
-- ------------------------------------------------------
...
CREATE TABLE `transaksi` (
  ...
  `tanggal_kembali_realisasi` time DEFAULT NULL,
  ...
  `kerusakan` char(50) DEFAULT NULL,
  `biaya_kerusakan` int(50) DEFAULT NULL,
  `biaya_bbm` int(50) DEFAULT NULL,
  PRIMARY KEY (`no_transaksi`),
  KEY `id_sopir` (`id_sopir`),
  KEY `no_ktp` (`no_ktp`),
  KEY `no_plat` (`no_plat`),
  CONSTRAINT `transaksi_ibfk_1` FOREIGN KEY (`id_sopir`) REFERENCES `sopir` (`id_sopir`),
  CONSTRAINT `transaksi_ibfk_2` FOREIGN KEY (`no_ktp`) REFERENCES `pelanggan` (`no_ktp`),
...
-- Dump completed on 2020-04-10 18:00:34
